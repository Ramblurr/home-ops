...
# ssh keys
set system login user vyos authentication public-keys cardno-000500006944 key ''
set system login user vyos authentication public-keys cardno-000500006944 type 'ssh-rsa'
set system login user vyos authentication public-keys JuiceSSH key 'AAAAE2VjZHNhLXNoYTItbmlzdHAzODQAAAAIbmlzdHAzODQAAABhBGIiONt3u8BdzaI/ndZLXuDnFBXwxbQ7Nr+Yq4BQNBuri49dknMrwjkPIqsUVUFo+hrfqEYnXlBLaKdof1ZpBdwwY2yHUO01EO18fIFkCswAoiHFf7TZO3a1Ekhnmuc1nw=='
