...
set firewall group address-group k8s_cluster_prod_nodes address '10.9.9.134'
set firewall group address-group k8s_cluster_prod_nodes address '10.9.10.121'
set firewall group address-group k8s_cluster_prod_nodes address '10.9.10.122'
set firewall group address-group k8s_cluster_prod_nodes address '10.9.10.123'
set firewall group address-group k8s_cluster_prod_nodes address '10.9.10.124'
set firewall group address-group k8s_cluster_prod_nodes address '10.9.10.125'
set firewall group address-group k8s_cluster_prod_nodes address '10.9.10.130'
set firewall group address-group k8s_cluster_prod_nodes address '10.9.10.131'
set firewall group address-group k8s_cluster_prod_nodes address '10.9.10.132'
set firewall group address-group k8s_cluster_prod_nodes address '10.9.10.133'
set firewall group address-group k8s_cluster_prod_nodes address '10.9.10.134'
