...
set container name dnsdist image 'docker.io/powerdns/dnsdist-18:1.8.4'
...
set container name udp-broadcast-relay-roon image 'ghcr.io/onedr0p/udp-broadcast-relay-redux:1.0.28'
...
set container name udp-broadcast-relay-syncthing image 'ghcr.io/onedr0p/udp-broadcast-relay-redux:1.0.28'
