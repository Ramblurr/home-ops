...
set firewall name iot-primary rule 6 description 'Rule: accept_wall_dashboard_to_ingress'
set firewall name iot-primary rule 6 source group address-group 'wall-dashboards'
set firewall name iot-primary rule 6 destination group address-group 'home_ops_ingress'
set firewall name iot-primary rule 6 destination port 'http,https'
...
set firewall name iot-primary rule 8 action 'accept'
set firewall name iot-primary rule 8 description 'Rule: accept_wall_dashboard_to_homeassistant'
set firewall name iot-primary rule 8 source group address-group 'wall-dashboards'
set firewall name iot-primary rule 8 destination group address-group 'homeassistant'
set firewall name iot-primary rule 8 destination group port-group 'homeassistant'
set firewall name iot-primary rule 8 protocol 'tcp_udp'
...
set firewall name primary-local rule 15 action 'accept'
set firewall name primary-local rule 15 description 'Rule: accept_syncthing'
set firewall name primary-local rule 15 destination group port-group 'syncthing'
set firewall name primary-local rule 15 protocol 'tcp_udp'

set firewall name primary-local rule 16 action 'accept'
set firewall name primary-local rule 16 description 'Rule: accept_syncthing'
set firewall name primary-local rule 16 source group port-group 'syncthing'
set firewall name primary-local rule 16 protocol 'tcp_udp'
