...
set firewall name lan-not rule 1 description 'Rule: accept_admin_to_wled'
set firewall name lan-not rule 1 destination group port-group 'wled-api'
set firewall name lan-not rule 1 destination group address-group 'wled'
set firewall name lan-not rule 1 protocol 'tcp'
set firewall name lan-not rule 1 source group address-group 'admin'

set firewall name lan-not rule 2 action 'accept'
set firewall name lan-not rule 2 description 'Rule: accept_admin_to_esphome'
set firewall name lan-not rule 2 destination group port-group 'esphome-api'
set firewall name lan-not rule 2 destination group address-group 'esphome'
set firewall name lan-not rule 2 protocol 'tcp'
