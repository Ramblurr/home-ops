...
set service dhcp-server shared-network-name NOT subnet 10.8.60.0/23 static-mapping bedroom-dimmer ip-address '10.8.60.28'
set service dhcp-server shared-network-name NOT subnet 10.8.60.0/23 static-mapping bedroom-dimmer mac-address '3c:61:05:e3:dc:a4'
...
set service dhcp-server shared-network-name PRIMARY subnet 10.9.4.0/22 static-mapping quine mac-address '92:50:df:e5:96:29'
...
set service dhcp-server shared-network-name PRIMARY subnet 10.9.4.0/22 static-mapping debord-prim ip-address '10.9.4.21'
set service dhcp-server shared-network-name PRIMARY subnet 10.9.4.0/22 static-mapping debord-prim mac-address '48:21:0b:3f:fc:7e'
...
set service dhcp-server shared-network-name PRIMARY subnet 10.9.4.0/22 static-mapping homeassistant mac-address '52:54:00:ed:51:65'
...
set service dhcp-server shared-network-name PRIMARY subnet 10.9.4.0/22 static-mapping ovos-bedroom-prim ip-address '10.9.6.29'
...
# 10.9.6.32 / reserved for phoniebox-dev macvlan container
set service dhcp-server shared-network-name PRIMARY subnet 10.9.4.0/22 static-mapping phoniebox1 ip-address '10.9.6.33'
set service dhcp-server shared-network-name PRIMARY subnet 10.9.4.0/22 static-mapping phoniebox1 mac-address 'dc:a6:32:40:33:ea'
# 10.9.6.34 / reserved for phoniebox1 macvlan container
...
set service dhcp-server shared-network-name MGMT subnet 10.9.8.0/23 static-mapping quine-mgmt ip-address '10.9.8.33'
