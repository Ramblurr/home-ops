...
##set service dhcp-server shared-network-name LAN subnet 192.168.1.0/24 static-mapping mill ip-address '192.168.1.13'
##set service dhcp-server shared-network-name LAN subnet 192.168.1.0/24 static-mapping mill mac-address ''
##set service dhcp-server shared-network-name LAN subnet 192.168.1.0/24 static-mapping witt ip-address '192.168.1.11'
##set service dhcp-server shared-network-name LAN subnet 192.168.1.0/24 static-mapping witt mac-address ''
##set service dhcp-server shared-network-name LAN subnet 192.168.1.0/24 static-mapping debord ip-address '192.168.1.16'
##set service dhcp-server shared-network-name LAN subnet 192.168.1.0/24 static-mapping debord mac-address ''
##set service dhcp-server shared-network-name LAN subnet 192.168.1.0/24 static-mapping peirce ip-address '192.168.1.21'
##set service dhcp-server shared-network-name LAN subnet 192.168.1.0/24 static-mapping peirce mac-address ''
##set service dhcp-server shared-network-name LAN subnet 192.168.1.0/24 static-mapping ibnsina ip-address '192.168.1.16'
##set service dhcp-server shared-network-name LAN subnet 192.168.1.0/24 static-mapping ibnsina mac-address ''
...
set service dhcp-server shared-network-name PRIMARY subnet 10.9.4.0/22 static-mapping mali ip-address '10.9.4.10'
set service dhcp-server shared-network-name PRIMARY subnet 10.9.4.0/22 static-mapping mali mac-address '58:9c:fc:10:02:7b'
...
#set service dhcp-server shared-network-name MGMT subnet 10.9.8.0/23 static-mapping mali ip-address '10.9.8.3'
#set service dhcp-server shared-network-name MGMT subnet 10.9.8.0/23 static-mapping mali mac-address '58:9c:fc:10:ff:e6'
set service dhcp-server shared-network-name MGMT subnet 10.9.8.0/23 static-mapping witt ip-address '10.9.8.11'
set service dhcp-server shared-network-name MGMT subnet 10.9.8.0/23 static-mapping witt mac-address 'f2:50:f3:df:1b:d4'
set service dhcp-server shared-network-name MGMT subnet 10.9.8.0/23 static-mapping mill ip-address '10.9.8.13'
set service dhcp-server shared-network-name MGMT subnet 10.9.8.0/23 static-mapping mill mac-address 'da:10:5b:71:cc:5b'
set service dhcp-server shared-network-name MGMT subnet 10.9.8.0/23 static-mapping ibnsina ip-address '10.9.8.16'
set service dhcp-server shared-network-name MGMT subnet 10.9.8.0/23 static-mapping ibnsina mac-address '5a:28:28:1b:a1:ff'
set service dhcp-server shared-network-name MGMT subnet 10.9.8.0/23 static-mapping peirce ip-address '10.9.8.18'
set service dhcp-server shared-network-name MGMT subnet 10.9.8.0/23 static-mapping peirce mac-address 'a2:87:87:15:2c:f3'
set service dhcp-server shared-network-name MGMT subnet 10.9.8.0/23 static-mapping debord ip-address '10.9.8.21'
set service dhcp-server shared-network-name MGMT subnet 10.9.8.0/23 static-mapping debord mac-address 'ca:f3:05:c0:bc:6a'
...
#set service dhcp-server shared-network-name DATA subnet 10.9.10.0/23 static-mapping witt ip-address '10.9.10.11'
#set service dhcp-server shared-network-name DATA subnet 10.9.10.0/23 static-mapping witt mac-address ''
#set service dhcp-server shared-network-name DATA subnet 10.9.10.0/23 static-mapping mali ip-address '10.9.10.10'
#set service dhcp-server shared-network-name DATA subnet 10.9.10.0/23 static-mapping mali mac-address '58:9c:fc:10:ff:eb'
#set service dhcp-server shared-network-name DATA subnet 10.9.10.0/23 static-mapping mill ip-address '10.9.10.13'
#set service dhcp-server shared-network-name DATA subnet 10.9.10.0/23 static-mapping mill mac-address '32:c9:fe:64:39:80'
#set service dhcp-server shared-network-name DATA subnet 10.9.10.0/23 static-mapping ibnsina ip-address '10.9.10.16'
#set service dhcp-server shared-network-name DATA subnet 10.9.10.0/23 static-mapping ibnsina mac-address '46:8c:b9:1d:2e:9e'
#set service dhcp-server shared-network-name DATA subnet 10.9.10.0/23 static-mapping peirce ip-address '10.9.10.18'
#set service dhcp-server shared-network-name DATA subnet 10.9.10.0/23 static-mapping peirce mac-address '5a:af:63:48:9e:07'
#set service dhcp-server shared-network-name DATA subnet 10.9.10.0/23 static-mapping debord ip-address '10.9.10.21'
#set service dhcp-server shared-network-name DATA subnet 10.9.10.0/23 static-mapping debord mac-address 'ee:e4:88:06:c5:82'
